...
//Класс PayrollSession представляет собой конкретную сессию расчета заработной платы, 
// которая содержит идентификатор, метку периода, дату проведения и коллекцию зарплатных ведомостей.
