...
#include <iomanip>
//Класс SalarySlip представляет собой документ о выплате заработной платы(ведомость),
// содержащий уникальный код ведомости, сумму выплаты, тип выплаты, дату выдачи и ссылку на сотрудника.
...
void SalarySlip::showAsTable() const {
    ...
    TableFormatter::Formatter table(headers); 
