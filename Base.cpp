...
// Класс EmployeeBase служит основой для работы с кадрами, предоставляя функционал просмотра,
// выбора и редактирования сотрудников различных типов - обычных работников, менеджеров, продавцов, почасовых сотрудников и сотрудников с премиями.
//гостевой режим просомтр сотрудников, выбор 
//пользователь редактирование данных просмотр ведомостей добавление периодов 
//админ редактирование данных сотрудников изменения информации в ведомостях просмотр детальной информации по сессиям и периодам 
